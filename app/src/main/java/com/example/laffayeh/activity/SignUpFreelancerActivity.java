...
public class SignUpFreelancerActivity extends AppCompatActivity {
    Uri downloadUrl;
    Button submit;
    EditText uname ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_up_freelancer);
        submit = findViewById(R.id.submit);
        uname = findViewById(R.id.fname);
    ...
    public void Submit(View view) {
        ...
        SharedPreferences daftar = PreferenceManager.getDefaultSharedPreferences(SignUpFreelancerActivity.this);
        ...
        Toast.makeText(SignUpFreelancerActivity.this,"SignUp was successfully",Toast.LENGTH_LONG).show();
        daftar = PreferenceManager.getDefaultSharedPreferences(SignUpFreelancerActivity.this);
