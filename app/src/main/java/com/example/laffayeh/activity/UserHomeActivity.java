...
public class UserHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_my_profile_office, R.id.nav_favorite,
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                SharedPreferences daftar = PreferenceManager.getDefaultSharedPreferences(UserHomeActivity.this);
                tvName.setText(daftar.getString("name" , ""));
                tvPhone.setText("0" + daftar.getString("phone" , ""));
                Glide.with(UserHomeActivity.this).load(daftar.getString("pic" , "")).into(imgUser);
            }
        }, 1500);
